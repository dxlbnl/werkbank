...
- Alle inhoud leeft in `subprojecten/*.md` (één bestand per onderdeel), `ideeen.md` (backlog) en `overzicht.html` (visueel overzicht, geen bron van waarheid).
...
- `overzicht.html` is het bouwplan met plattegrond, aangezicht en vaktermenlijst (actuele revisie staat in het titelblok van de html). Bij tegenspraak met een subproject-md wint de md.
