...
Dit is het werkbankproject van Dexter: levende documentatie voor het ontwerpen en bouwen van een werkbank. Lees bij het begin van een sessie **`WERKWIJZE.md`** — daar staan de afspraken over hoe deze repo werkt.
...
- `overzicht.html` is het tekeningenblad: alléén schematische tekeningen (actuele revisie staat in het titelblok). Bij tegenspraak met een md wint de md.
- Dexter leert houtbewerkings-vaktermen: noem bij Engelse termen altijd de Nederlandse vakterm (en andersom), bv. bench dog / bankhaak, rip cut / schulpen, kerf / zaagsnede. Nieuwe termen toevoegen aan `vaktermen.md`.
