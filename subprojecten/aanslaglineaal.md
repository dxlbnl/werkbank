...
- Profiel (keuze open, zie 12-08): 20×40 mm T-sleuf plat gelegd (eerder besluit, nu optie), 30×60/40×80 T-sleuf (advies fence-sessie 06-08), of iets anders dan een aluminiumprofiel — opties verzamelen.
...
- **Welke fence wordt het?** Profieltype/vorm is heropend — andere opties dan het T-sleufprofiel meenemen.
- Klapaanslag: ontwerpen of downloaden en printen; meetlinthouder.
- Kalibratie-workflow meetlint na wissel van zaagblad.
- Profielengte (± 150–200 cm) en leverancier.
