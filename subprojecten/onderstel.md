...
- Lengteverbindingen demontabel, drie smaken: **(a)** onverlijmde drop-in zwaluwstaarten van boven in de pootkoppen — let op: de kamer zit dan in kops hout (end grain) en de wiggende wangen kunnen langs de draad afsplijten; alleen doen met dikke wangen (≥ ~25 mm), ondiepe kamer, flauwe hoek (1:8) en het blad als deksel erop geschroefd; **(b)** verzonken schuifzwaluwstaart (sliding dovetail) een paar cm onder de pootkop, dwars door het pootvlak — langshout boven de kamer, geen afsplijt-pad, maar geen drop-in-montage; **(c)** doorgaande pen met spie (wedged through tenon, Moravisch) of slotbouten (bench bolts) met borstpen — beproefd demontabel, natrekbaar, geen zwak punt. Voorkeursvolgorde qua sterkte in vuren: c > b > a.
