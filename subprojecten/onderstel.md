...
- **2026-08-14** — **Hoogte-offset kopregels:** de kopregels en de lange regels komen anders in dezelfde pootzone samen (beide flush binnen, beide bovenin — botsende verbindingen, opgemerkt door Dexter). Oplossing: kopregels in hoogte verzetten — boven: bovenkant ~5 cm onder de pootkop (onder de drop-in kamer); onder: de kop-onderregel iets hóger dan de lange onderregel. Pennen en staarten missen elkaar dan in de poot.
