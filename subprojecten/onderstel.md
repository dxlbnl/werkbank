...
- **2026-08-14** — **Schort zonder zichtbevestiging:** geen schroeven van buitenaf door het schort. De voorregel ligt (door de binnenvlak-uitlijning) ~50 mm achter de schortrug en kan het schort dus niet dragen. Bevestiging: lijm in de bladsponning (doorlopende langshoutnaad van 2 m) + **verzonken schroeven dóór de voorpoten** in de schortrug (diepe verzinking van binnenuit; 14-08, vervangt de zakgat-variant). Werking schort (dwars op de draad, ~2–4 mm over 200 mm hoogte, alles naar beneden omdat de top in de sponning vastzit): bovenste schroef vast binnen ~5 cm onder de sponning, onderin niet schroeven of door een verticale sleuf; schort níét volvlaks aan de poot lijmen. Registratie op de poten: keep in de poot (12-08). **Principe: het schort is verticaal ontkoppeld en horizontaal gekoppeld** — het hangt aan het blad (sponning) en rust nérgens verticaal op de poot; de keep geleidt alleen in de diepte, de bovenschroef draagt de schuifkracht (schoren). Anders dan bij een Nicholson/Krueger-schort (dat wél draagt, met het draagpunt vlak onder de bladlijn) kan werking hier het blad dus niet omhoog duwen.
