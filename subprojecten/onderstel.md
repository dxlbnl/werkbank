...
| 2 | zijplaten | 18 mm plaat | ~92 × ~56 cm | tegen de poten geschroefd (demontabel); exacte maat en positie volgen uit de bladoplegging-detaillering |
...
- Borging van de pen-en-gatverbindingen (onderregels): drawbore-deuvel, of onverlijmd + slotbout? (Demontabel houden.)
- Zijplaten: bladoplegging via de plaatbovenrand, positie (binnen-/buitenzijde poten), schroefpatroon.
...
- Exacte pen- en staartmaten (dikte, schouderbreedtes, inlaatdieptes) én hap-maten schort (diepte, flankhoek, speling) — bij de detailtekening.
